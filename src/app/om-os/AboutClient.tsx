...
export default function AboutPage({ faqs = [] }: { faqs?: { q: string; a: string }[] }) {
  ...
  return (
    <main>
      ...
      {/* ─── VISION ───────────────────────────────────────────── */}
      <section className="py-12 sm:py-20 bg-blue-950 relative overflow-hidden">
        <div className="absolute inset-0">
      ...
      {/* ─── CTA ──────────────────────────────────────────────── */}
      <section className="py-12 sm:py-20 bg-gradient-to-br from-blue-950 via-blue-900 to-blue-800 relative overflow-hidden mt-16">
