...
const STRIPE_CONTENT_OVERRIDE: Record<string, Partial<Product>> = {
  ...
  'prod_VJ1JDGsfJxyr4r': {
    ...
    tagline: 'Så kan du klikke dit vandhanefilter på – til haner med gevind på indersiden',
    description: 'En lille kobling, der gør det nemt at sætte dit Baclyser® neo-vandhanefilter på hanen – helt uden værktøj. Du sætter koblingen på hanen én gang, og så klikker du bare filteret af og på, når det skal skiftes. Denne passer til vandhaner, hvor gevindet (de små riller) sidder inde i selve mundingen.',
    longDescription: 'Koblingen er det lille mellemstykke, der gør, at du kan klikke dit filter fast på vandhanen. Du sætter koblingen på hanen én gang, og bagefter klikker du bare filteret af og på uden værktøj, når det skal skiftes.\n\nSådan ved du, om det er den her, du skal bruge: kig på din vandhanes munding, dér hvor vandet løber ud. Sidder gevindet (de små riller) på indersiden, skal du bruge denne. Sidder de udenpå, skal du bruge Coupling M24 i stedet. Er du i tvivl, så kontakt os – vi hjælper dig med at finde den rigtige.\n\nKoblingen er solid og holdbar og passer til alle vores Baclyser® neo-filtre.',
    highlights: ['Klik filteret på – helt uden værktøj', 'Til haner med gevind på indersiden', 'Passer til alle Baclyser® neo-filtre', 'Solid og holdbar'],
    features: ['Sæt koblingen på hanen én gang', 'Klik filteret af og på uden værktøj', 'Til vandhaner med gevind på indersiden', 'Passer til alle Baclyser® neo-filtre', 'Solid og holdbar'],
    specs: [
      { label: 'Bruges til', value: 'At sætte vandhanefilter på hanen' },
      { label: 'Passer til', value: 'Haner med gevind på indersiden' },
      { label: 'Montering', value: 'Klik-på – uden værktøj' },
      { label: 'Materiale', value: 'Metal' },
      { label: 'Varenr.', value: '100296' },
    ],
    faqs: [
      { q: 'Hvad er en kobling?', a: 'Koblingen er et lille mellemstykke, du sætter på din vandhane. Bagefter kan du klikke filteret af og på uden værktøj – du skal altså have en kobling for at kunne bruge filteret.' },
      { q: 'Skal jeg bruge M22 eller M24?', a: 'Kig på din vandhanes munding, dér hvor vandet løber ud. Sidder gevindet (de små riller) på indersiden, skal du bruge denne. Sidder de udenpå, skal du bruge Coupling M24. Er du i tvivl, så kontakt os – vi hjælper dig.' },
      { q: 'Skal jeg bruge værktøj?', a: 'Nej. Du sætter koblingen på hanen med hånden, og filteret klikkes bare af og på.' },
      { q: 'Hvilke filtre passer på?', a: 'Alle vores Baclyser® neo-vandhanefiltre passer på koblingen.' },
    ],
  ...
  'prod_VJ1QAt4Yw2Dju4': {
    ...
    tagline: 'Så kan du klikke dit vandhanefilter på – til haner med gevind på ydersiden',
    description: 'En lille kobling, der gør det nemt at sætte dit Baclyser® neo-vandhanefilter på hanen – helt uden værktøj. Du sætter koblingen på hanen én gang, og så klikker du bare filteret af og på, når det skal skiftes. Denne passer til vandhaner, hvor gevindet (de små riller) sidder udenpå mundingen.',
    longDescription: 'Koblingen er det lille mellemstykke, der gør, at du kan klikke dit filter fast på vandhanen. Du sætter koblingen på hanen én gang, og bagefter klikker du bare filteret af og på uden værktøj, når det skal skiftes.\n\nSådan ved du, om det er den her, du skal bruge: kig på din vandhanes munding, dér hvor vandet løber ud. Sidder gevindet (de små riller) udenpå, skal du bruge denne. Sidder de på indersiden, skal du bruge Coupling M22 i stedet. Er du i tvivl, så kontakt os – vi hjælper dig med at finde den rigtige.\n\nKoblingen er solid og holdbar og passer til alle vores Baclyser® neo-filtre.',
    highlights: ['Klik filteret på – helt uden værktøj', 'Til haner med gevind på ydersiden', 'Passer til alle Baclyser® neo-filtre', 'Solid og holdbar'],
    features: ['Sæt koblingen på hanen én gang', 'Klik filteret af og på uden værktøj', 'Til vandhaner med gevind på ydersiden', 'Passer til alle Baclyser® neo-filtre', 'Solid og holdbar'],
    specs: [
      { label: 'Bruges til', value: 'At sætte vandhanefilter på hanen' },
      { label: 'Passer til', value: 'Haner med gevind på ydersiden' },
      { label: 'Montering', value: 'Klik-på – uden værktøj' },
      { label: 'Materiale', value: 'Metal' },
    ...
    faqs: [
      { q: 'Hvad er en kobling?', a: 'Koblingen er et lille mellemstykke, du sætter på din vandhane. Bagefter kan du klikke filteret af og på uden værktøj – du skal altså have en kobling for at kunne bruge filteret.' },
      { q: 'Skal jeg bruge M22 eller M24?', a: 'Kig på din vandhanes munding, dér hvor vandet løber ud. Sidder gevindet (de små riller) udenpå, skal du bruge denne. Sidder de på indersiden, skal du bruge Coupling M22. Er du i tvivl, så kontakt os – vi hjælper dig.' },
      { q: 'Skal jeg bruge værktøj?', a: 'Nej. Du sætter koblingen på hanen med hånden, og filteret klikkes bare af og på.' },
      { q: 'Hvilke filtre passer på?', a: 'Alle vores Baclyser® neo-vandhanefiltre passer på koblingen.' },
    ],
