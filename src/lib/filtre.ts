...
export const FILTRE: Filter[] = [
  {
    ...
    art: 'Art. F0M',
    img: '/images/filter-universal-v2.jpg',
    images: ['/images/filter-universal-v2.jpg', '/images/filter-biflux-universal-lg.png', '/images/filter-biflux-universal-box.png'],
  ...
  },
  {
    ...
    art: 'Art. H0L',
    img: '/images/filter-limescalestop-v2.jpg',
    images: ['/images/filter-limescalestop-v2.jpg', '/images/limescalestop-cartridge.png'],
  ...
  },
  {
    ...
    art: 'Art. P3M',
    img: '/images/filter-healthexpert-v2.jpg',
    images: ['/images/filter-healthexpert-v2.jpg', '/images/healthexpert-cartridge.png', '/images/healthexpert-box.png'],
