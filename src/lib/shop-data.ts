...
const SHOP_TAGLINES: Record<string, string> = {
  'prod_V2wDbJ1i8O20Kj': 'Stopper 99,999 % af bakterier* · sikkert drikkevand til hele familien',
...
export async function getMergedShopProducts(): Promise<Product[]> {
  ...
  // Fast rækkefølge på Laica-filtrene – FAST DISK og Universal byttet om
  orderIndex.set('prod_V2wHIQrdoXx6RG', 10000)        // FAST DISK™ (først)
