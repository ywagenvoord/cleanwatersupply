...
export const PRODUCTS: Product[] = [
...

  {
    ...
    highlights: ['Bi-flux® 6-trins filtrering', 'Udskifteligt filter', 'Passer i køleskabsdøren', 'Fremstillet i EU'],
    features: [
...

  {
    ...
    description: 'Bi-flux® HealthExpert giver maksimal beskyttelse. Det reducerer PFAS (“evighedskemikalier”) med op til 92 % og øger magnesium-indholdet i vandet. Reducerer også mikroplast, klor, kalk og tungmetaller. Passer også til Brita®-kander. 2 stk. i pakken.',
    longDescription: 'Bi-flux® HealthExpert giver maksimal beskyttelse. Det reducerer PFAS (“evighedskemikalier”) med op til 92 % og øger samtidig magnesium-indholdet i vandet – godt for hjerte og hjerne. 5-trins filtrering reducerer også mikroplast, klor, kalk og tungmetaller. Passer i Laica-kander og også til Brita®-kander (LAICA-Key medfølger). Ét filter rækker til ca. 150 liter / ca. 1 måned. Leveres i pakke med 2 filtre.',
    highlights: ['Reducerer PFAS op til 92 %', 'Tilfører magnesium', 'Også mikroplast, klor & kalk · 2-pak'],
    features: [
    ...
    faqs: [
      { q: 'Fjerner det PFAS?', a: 'HealthExpert reducerer PFAS (“evighedskemikalier”) med op til 92 % og filtrerer samtidig mikroplast, klor, kalk og tungmetaller.' },
      { q: 'Passer det i Brita®-kander?', a: 'Ja, det passer også til Brita®-kander – en LAICA-Key til Brita medfølger.' },
    ],
