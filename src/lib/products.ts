...
export const PRODUCTS: Product[] = [
...

  {
    ...
    highlights: ['Bi-flux® 6-trins filtrering', 'Passer i køleskabsdøren', 'Elektronisk skift-indikator · Made in EU'],
    features: [
    ...
    alsoBought: ['vandfilter-biflux-reservedel', 'baclyser-neo-tl-2m'],
  },
