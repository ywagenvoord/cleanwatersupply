...
export const PRODUCTS: Product[] = [
...

  {
    ...
    description: 'En lille adapter, der gør det nemt at sætte dit Baclyser® neo-vandhanefilter på hanen – helt uden værktøj. Du sætter adapteren på hanen én gang, og så klikker du bare filteret af og på, når det skal skiftes. Denne passer til vandhaner, hvor gevindet (de små riller) sidder inde i selve mundingen.',
    longDescription: 'Adapteren er det lille mellemstykke, der gør, at du kan sætte dit filter fast på vandhanen. Du sætter adapteren på hanen én gang, og bagefter klikker du bare filteret af og på uden værktøj, når det skal skiftes.\n\nSådan ved du, om det er den her, du skal bruge: kig på din vandhanes munding, dér hvor vandet løber ud. Sidder gevindet (de små riller) på indersiden, skal du bruge denne. Sidder de udenpå, skal du bruge Manuel adapter M24 i stedet. Er du i tvivl, så kontakt os – vi hjælper dig med at finde den rigtige.\n\nAdapteren er solid og holdbar og passer til alle vores Baclyser® neo-filtre.',
    ...
    features: [
      'Sæt adapteren på hanen én gang',
      'Klik filteret af og på uden værktøj',
      'Til vandhaner med gevind på indersiden',
      'Passer til alle Baclyser® neo-filtre',
      'Solid og holdbar',
    ],
    specs: [
    ...
    faqs: [
      { q: 'Hvad er en adapter?', a: 'Adapteren er et lille mellemstykke, du sætter på din vandhane. Bagefter kan du klikke filteret af og på uden værktøj – du skal altså have en adapter for at kunne bruge filteret.' },
      { q: 'Skal jeg bruge M22 eller M24?', a: 'Kig på din vandhanes munding, dér hvor vandet løber ud. Sidder gevindet (de små riller) på indersiden, skal du bruge denne. Sidder de udenpå, skal du bruge Manuel adapter M24. Er du i tvivl, så kontakt os – vi hjælper dig.' },
      { q: 'Skal jeg bruge værktøj?', a: 'Nej. Du sætter adapteren på hanen med hånden, og filteret klikkes bare af og på.' },
      { q: 'Hvilke filtre passer på?', a: 'Alle vores Baclyser® neo-vandhanefiltre passer på adapteren.' },
    ],
    useCases: [],
...

  {
    ...
    compatibleFilters: ['baclyser-neo-tr-2m', 'baclyser-neo-tl-2m'],
    installVideo: '/videos/coupling-montering.mp4',
    description: 'En lille adapter, der gør det nemt at sætte dit Baclyser® neo-vandhanefilter på hanen – helt uden værktøj. Du sætter adapteren på hanen én gang, og så klikker du bare filteret af og på, når det skal skiftes. Denne passer til vandhaner, hvor gevindet (de små riller) sidder udenpå mundingen.',
    longDescription: 'Adapteren er det lille mellemstykke, der gør, at du kan sætte dit filter fast på vandhanen. Du sætter adapteren på hanen én gang, og bagefter klikker du bare filteret af og på uden værktøj, når det skal skiftes.\n\nSådan ved du, om det er den her, du skal bruge: kig på din vandhanes munding, dér hvor vandet løber ud. Sidder gevindet (de små riller) udenpå, skal du bruge denne. Sidder de på indersiden, skal du bruge Manuel adapter M22 i stedet. Er du i tvivl, så kontakt os – vi hjælper dig med at finde den rigtige.\n\nAdapteren er solid og holdbar og passer til alle vores Baclyser® neo-filtre.',
    ...
    features: [
      'Sæt adapteren på hanen én gang',
      'Klik filteret af og på uden værktøj',
      'Til vandhaner med gevind på ydersiden',
      'Passer til alle Baclyser® neo-filtre',
      'Solid og holdbar',
    ],
    specs: [
    ...
    faqs: [
      { q: 'Hvad er en adapter?', a: 'Adapteren er et lille mellemstykke, du sætter på din vandhane. Bagefter kan du klikke filteret af og på uden værktøj – du skal altså have en adapter for at kunne bruge filteret.' },
      { q: 'Skal jeg bruge M22 eller M24?', a: 'Kig på din vandhanes munding, dér hvor vandet løber ud. Sidder gevindet (de små riller) udenpå, skal du bruge denne. Sidder de på indersiden, skal du bruge Manuel adapter M22. Er du i tvivl, så kontakt os – vi hjælper dig.' },
      { q: 'Skal jeg bruge værktøj?', a: 'Nej. Du sætter adapteren på hanen med hånden, og filteret klikkes bare af og på.' },
      { q: 'Hvilke filtre passer på?', a: 'Alle vores Baclyser® neo-vandhanefiltre passer på adapteren.' },
    ],
    useCases: [],
...

  {
    ...
    category: 'vandkande',
    price: 89,
    imgSrc:   '/images/filter-universal-v2.jpg',
    imgLarge: '/images/filter-universal-v2.jpg',
    ...
    longDescription: 'Bi-flux® Universal er Laicas alsidige hverdagsfilter til filtervandkander. Med 6-trins filtrering ved kontrolleret hastighed reducerer det klor, visse tungmetaller og pesticider og forebygger kalk – samtidig med at de nyttige mineralsalte (calcium, magnesium og kalium) bevares. BPA-fri, som loven kræver, og Made in EU. Ét filter rækker til ca. 150 liter / ca. 1 måned. Leveres i pakke med 2 filtre.',
    ...
    features: [
      ...
      '2 filtre i pakken · BPA-fri (lovkrav) · Made in EU',
    ],
    specs: [
...

  {
    ...
    category: 'vandkande',
    price: 99,
    imgSrc:   '/images/filter-limescalestop-v2.jpg',
    imgLarge: '/images/filter-limescalestop-v2.jpg',
...

  {
    ...
    category: 'vandkande',
    price: 109,
    imgSrc:   '/images/filter-healthexpert-v2.jpg',
    imgLarge: '/images/filter-healthexpert-v2.jpg',
    ...
    features: [
      ...
      '2 filtre i pakken · BPA-fri (lovkrav) · produceret i EU',
    ],
    specs: [
      { label: 'Type',           value: 'Bi-flux® udskiftningsfilter' },
      { label: 'Pakke',          value: '2 stk. i pakken' },
    ...
    faqs: [
      { q: 'Hvad er PFAS?', a: 'PFAS er kemikalier, der bruges i bl.a. imprægnering, emballage og maling, og som kan ende i naturen og nogle gange i drikkevandet. De kaldes “evighedskemikalier”, fordi de næsten ikke forsvinder af sig selv, og for meget af dem er mistænkt for at være skidt for helbredet. HealthExpert fjerner op til 92 % af dem, hvis de er i dit postevand.' },
      { q: 'Hvorfor tilfører filteret magnesium?', a: 'Magnesium er et mineral, kroppen skal bruge hver dag – det hjælper mod træthed, holder musklerne i gang og er godt for hjerte og humør. Mange får for lidt. De fleste filtre fjerner kun; dette giver lidt magnesium tilbage til vandet, så du får en lille ekstra hjælp bare ved at drikke det, du alligevel drikker.' },
    ...
    sellStory: {
      ...
      intro: 'Postevand er godt i Danmark, men på vejen gennem husets rør kan der komme ting med, du helst er foruden. Dette filter renser vandet i din kande – og gør det endda en lille smule sundere. Her er, hvad det betyder i hverdagen:',
      cards: [
        { icon: 'shield', title: 'Hvad er PFAS – og hvorfor væk med det?', text: 'PFAS er kemikalier fra bl.a. imprægnering, emballage og maling, som havner i naturen og nogle gange i drikkevandet. De kaldes “evighedskemikalier”, fordi de næsten ikke forsvinder af sig selv – og for meget af dem er mistænkt for at være skidt for helbredet. Filteret fjerner op til 92 % af dem, hvis de er i dit vand. Kort sagt: renere vand, uden du skal tænke over det.' },
        { icon: 'heart', title: 'Hvad gør magnesium for dig?', text: 'Magnesium er et mineral, kroppen skal bruge hver dag. Det hjælper mod træthed, holder musklerne i gang og er godt for hjerte og humør – og mange får for lidt. Dette filter giver lidt magnesium tilbage til vandet, så du får en lille ekstra hjælp bare ved at drikke det, du alligevel drikker.' },
        { icon: 'glass', title: 'Hvad kan du mærke i hverdagen?', text: 'Vandet smager renere og friskere, fordi klor, kalk og mikroplast bliver filtreret fra. Ingen “poolsmag”, ingen kalkrande i glasset – bare koldt, godt vand, som børnene faktisk gider drikke.' },
        { icon: 'spark', title: 'Nemt og billigt', text: 'Sæt filteret i din kande (Laica eller Brita®), fyld vand i, og hæld op. Ét filter holder cirka en måned og koster få kroner om dagen – meget billigere end flaskevand, og du sparer bunker af plastik.' },
      ],
      closing: 'Ét lille filter i kanden – renere vand og en lille sundhedsgevinst hver dag.',
    },
    compatibleJugs: ['kande-carmen', 'kande-mikroplastik'],
    alsoBought: ['kande-carmen', 'filter-biflux-universal'],
  },

  {
    ...
    tagline: 'Udskiftningsfilter til Germ-STOP filterkanden – levetid op til 1000 liter',
    category: 'vandkande',
    ...
    description: 'Udskiftningsfilter til Germ-STOP filterkanden. Blokerer bakterier og over 99,5 % af mikroplast ned til 0,1 mikron. Levetid op til 1000 L. 1 stk.',
    longDescription: 'Germ-STOP er udskiftningsfilteret til Germ-STOP filterkanden. Det blokerer bakterier og over 99,5 % af mikroplast med en størrelse ≥ 0,1 mikron i postevandet, og for partikler ≥ 1 mikron er reduktionen ≥ 99,99 %. Effektiviteten er testet af uafhængige, akkrediterede laboratorier i Tyskland og Italien. Filteret er BPA-frit (lovkrav) og har en levetid på op til 1000 liter afhængigt af vandets kvalitet. Leveres som 1 filter.',
    highlights: ['Blokerer bakterier + >99,5 % mikroplast', 'Levetid op til 1000 liter', 'BPA-fri (lovkrav) · 1 filter pr. pakke'],
    features: [
    ...
    specs: [
      ...
      { label: 'Pakke',    value: '1 filter' },
      { label: 'Mål',      value: '72 × 55 × 55 mm' },
      { label: 'Vægt',     value: '66 g' },
      { label: 'Vare-nr.', value: 'DUF1P00' },
    ],
    faqs: [
      { q: 'Hvilken kande passer filteret til?', a: 'Det passer til Germ-STOP filterkanden.' },
  ...
  // ─── NYE ERHVERVSPRODUKTER (fra prisliste – grossistpriser, billeder følger) ───
  {
    ...
    badge: 'Tilbehør', category: 'vandhane', price: 129, priceErhverv: 100,
